...
<p>
  <strong class="text-gray-800">Designing with Tailwind CSS</strong> is a free video series that teaches you how to build fully responsive, professionally designed UIs from scratch using Tailwind CSS.
</p>
...
<div class="mt-8">
  <img class="rounded-lg" src="/img/workcation-screenshot.jpg" alt="">
</div>
<p class="mt-8 uppercase font-semibold text-gray-900 tracking-wider text-base">
  What you'll learn
</p>
...
<p class="mt-8 text-lg"><strong class="text-gray-800">Ready to start learning?</strong></p>
<div class="mt-4">
  <a href="/course/setting-up-tailwind-and-postcss" class="inline-flex items-center bg-gray-800 hover:bg-gray-700 focus:outline-none focus:bg-gray-700 px-6 py-3 rounded-lg text-white font-medium shadow text-lg">
    Get started
    <svg class="ml-2 h-4 w-4 fill-current text-gray-300" viewBox="0 0 24 24"><path d="M18.59 13H3a1 1 0 0 1 0-2h15.59l-5.3-5.3a1 1 0 1 1 1.42-1.4l7 7a1 1 0 0 1 0 1.4l-7 7a1 1 0 0 1-1.42-1.4l5.3-5.3z"/></svg>
  </a>
</div>