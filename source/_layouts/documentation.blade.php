...
<div class="w-full max-w-screen-xl mx-auto px-6">
  <div class="lg:flex -mx-6">
    ...
    {{-- Side nav --}}
    <div id="sidebar" class="hidden absolute z-90 top-28 bg-white w-full border-b -mb-16 lg:-mb-0 lg:static lg:bg-transparent lg:border-b-0 lg:pt-0 lg:w-1/4 lg:block lg:border-0 xl:w-1/5">
      <div class="lg:block lg:relative lg:sticky lg:top-28">
        <nav id="nav" class="px-6 pt-6 overflow-y-auto text-base lg:text-sm lg:py-12 lg:pl-6 lg:pr-8 sticky?lg:h-(screen-28)">
    ...
    <div id="content-wrapper" class="min-h-screen w-full lg:static lg:max-h-full lg:overflow-visible lg:w-3/4 xl:w-4/5 ">
      ...
      <div id="content">
        ...
        <div id="app" class="flex" v-cloak>
          ...
          {{-- Main content area --}}
          <div class="pt-36 pb-8 lg:pt-40 w-full">
            ...
            <div class="flex">
              ...
              <div class="hidden xl:text-sm xl:block xl:w-1/4 xl:px-6">
                <div class="flex flex-col justify-between overflow-y-auto sticky top-28 max-h-(screen-28) pt-12 pb-4 -mt-12">
