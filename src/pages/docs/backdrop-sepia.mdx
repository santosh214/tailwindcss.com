...
<template preview>
  <div class="grid grid-cols-2 gap-2 sm:grid-cols-5">
    <div class="relative h-16 rounded-md overflow-hidden">
      <div class="absolute inset-0 bg-center bg-cover" style="background-image:url('https://images.unsplash.com/photo-1608501821300-4f99e58bba77?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=256&q=80&duotone=6B21A8,7E22CE&duotone-alpha=50');"></div>
      <div class="absolute inset-0 bg-cover rounded-md backdrop-filter backdrop-sepia-0 overflow-hidden"></div>
    </div>
    <div class="relative h-16 rounded-md overflow-hidden">
      <div class="absolute inset-0 bg-center bg-cover" style="background-image:url('https://images.unsplash.com/photo-1608501821300-4f99e58bba77?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=256&q=80&duotone=6B21A8,7E22CE&duotone-alpha=50');"></div>
      <div class="absolute inset-0 bg-cover rounded-md backdrop-filter backdrop-sepia overflow-hidden"></div>
    </div>
  </div>
</template>
