...
<template preview>
  <div class="grid grid-cols-2 gap-2 sm:grid-cols-5">
    <div class="h-16 rounded-md bg-indigo-400 filter brightness-0"></div>
    <div class="h-16 rounded-md bg-indigo-400 filter brightness-50"></div>
    <div class="h-16 rounded-md bg-indigo-400 filter brightness-100"></div>
    <div class="h-16 rounded-md bg-indigo-400 filter brightness-150"></div>
    <div class="h-16 rounded-md bg-indigo-400 filter brightness-200"></div>
  </div>
</template>
