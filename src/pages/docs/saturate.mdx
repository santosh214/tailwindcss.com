...
<template preview>
  <div class="grid grid-cols-2 gap-2 sm:grid-cols-5">
    <div class="h-16 rounded-md bg-rose-400 filter saturate-0"></div>
    <div class="h-16 rounded-md bg-rose-400 filter saturate-50"></div>
    <div class="h-16 rounded-md bg-rose-400 filter saturate-100"></div>
    <div class="h-16 rounded-md bg-rose-400 filter saturate-150"></div>
    <div class="h-16 rounded-md bg-rose-400 filter saturate-200"></div>
  </div>
</template>
