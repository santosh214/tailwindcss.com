...
<template preview>
  <div class="grid grid-cols-2 gap-2 sm:grid-cols-5">
    <div class="h-16 rounded-md bg-amber-400 filter contrast-0"></div>
    <div class="h-16 rounded-md bg-amber-400 filter contrast-50"></div>
    <div class="h-16 rounded-md bg-amber-400 filter contrast-100"></div>
    <div class="h-16 rounded-md bg-amber-400 filter contrast-150"></div>
    <div class="h-16 rounded-md bg-amber-400 filter contrast-200"></div>
  </div>
</template>
