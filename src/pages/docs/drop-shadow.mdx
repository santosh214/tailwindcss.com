...
<template preview>
  <div class="grid grid-cols-2 gap-2 sm:grid-cols-5">
    <div class="h-16 rounded-md bg-white filter drop-shadow-sm"></div>
    <div class="h-16 rounded-md bg-white filter drop-shadow"></div>
    <div class="h-16 rounded-md bg-white filter drop-shadow-md"></div>
    <div class="h-16 rounded-md bg-white filter drop-shadow-lg"></div>
    <div class="h-16 rounded-md bg-white filter drop-shadow-2xl"></div>
  </div>
</template>
