...
<template preview>
  <div class="grid grid-cols-2 gap-2 sm:grid-cols-5">
    <div class="h-16 rounded-md bg-indigo-400 filter -hue-rotate-180"></div>
    <div class="h-16 rounded-md bg-indigo-400 filter -hue-rotate-60"></div>
    <div class="h-16 rounded-md bg-indigo-400 filter hue-rotate-0"></div>
    <div class="h-16 rounded-md bg-indigo-400 filter hue-rotate-60"></div>
    <div class="h-16 rounded-md bg-indigo-400 filter hue-rotate-180"></div>
  </div>
</template>
